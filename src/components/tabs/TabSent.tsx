...
import { grass, blackA, red } from '@radix-ui/colors';
...
import { clearEvents, selectEvents } from '../../redux/sender';
...
export default function TabSent() {
		...
		<div>
			<Table>
				...
				<Tr>
					...
					<Th scope="col"><Button onClick={() => dispatch(clearEvents())} css={{ backgroundColor: red.red7, '&:hover': { backgroundColor: red.red9 } }}>Clear Logs</Button></Th>
							...
							return (
								<Tr key={event.id}>
									...
									<Td css={{ display: 'flex', gap: '1' }}>
										<Button onClick={inspect(event.data)} css={{ margin: '7px', backgroundColor: grass.grass7, '&:hover': { backgroundColor: grass.grass9 } }}>
											View Payload
										</Button>
									</Td>
								</Tr>
